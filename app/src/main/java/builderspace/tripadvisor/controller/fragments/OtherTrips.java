...
import builderspace.tripadvisor.view.RecyclerFriendsTripsAdapter;

/**
 * A simple {@link Fragment} subclass.
 */
public class OtherTrips extends Fragment {

    private DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
    private FirebaseUser user;
    private User currentUser;
    private RecyclerView recyclerViewFriendsTrips;
    private RecyclerFriendsTripsAdapter recyclerFriendsTripsAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_other_trips, container, false);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                muidTrip.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        recyclerViewFriendsTrips = rootView.findViewById(R.id.recyclerViewFriendsTrips);
                        recyclerFriendsTripsAdapter = new RecyclerFriendsTripsAdapter(friendsTrips, currentUser);
                        recyclerViewFriendsTrips.setLayoutManager(new LinearLayoutManager(getContext()));
                        recyclerViewFriendsTrips.setAdapter(recyclerFriendsTripsAdapter);
